...
--> statement-breakpoint
ALTER TABLE `deliveries` ADD CONSTRAINT `deliveries_po_id_purchase_orders_id_fk` FOREIGN KEY (`po_id`) REFERENCES `purchase_orders`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `deliveries` ADD CONSTRAINT `deliveries_created_by_id_users_id_fk` FOREIGN KEY (`created_by_id`) REFERENCES `users`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `delivery_items` ADD CONSTRAINT `delivery_items_po_item_id_po_items_id_fk` FOREIGN KEY (`po_item_id`) REFERENCES `po_items`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `po_items` ADD CONSTRAINT `po_items_material_id_materials_id_fk` FOREIGN KEY (`material_id`) REFERENCES `materials`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `purchase_orders` ADD CONSTRAINT `purchase_orders_client_id_clients_id_fk` FOREIGN KEY (`client_id`) REFERENCES `clients`(`id`) ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `purchase_orders` ADD CONSTRAINT `purchase_orders_created_by_id_users_id_fk` FOREIGN KEY (`created_by_id`) REFERENCES `users`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
CREATE INDEX `clients_name_idx` ON `clients` (`name`);--> statement-breakpoint
CREATE INDEX `deliveries_po_idx` ON `deliveries` (`po_id`);--> statement-breakpoint
CREATE INDEX `delivery_items_delivery_idx` ON `delivery_items` (`delivery_id`);--> statement-breakpoint
CREATE INDEX `delivery_items_item_idx` ON `delivery_items` (`po_item_id`);--> statement-breakpoint
CREATE INDEX `materials_name_idx` ON `materials` (`name`);--> statement-breakpoint
CREATE INDEX `po_items_po_idx` ON `po_items` (`po_id`);--> statement-breakpoint
CREATE INDEX `po_client_idx` ON `purchase_orders` (`client_id`);--> statement-breakpoint
